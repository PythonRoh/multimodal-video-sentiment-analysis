...
class MultimodalSentimentModel(nn.Module):
    ...
    # CONCATENATION OF MULTIMODAL FEATURES AND FUSION
...
# APPLY CLASS IMBALANCE CHECK WITH CLASS WEIGHTS CALCULATION
...
class MultimodalTrainer:
    def __init__(self, model, train_loader, val_loader):
        ...
        # Define loss functions with class weights and label smoothing
